function sendData(){
    ...
    // const yop2=document.getElementById('fyop2').value;
    ...
    // const yop3=document.getElementById('fyop3').value;
    ...
    // const board4=document.getElementById('fBoard4').value;
    // const yop4=document.getElementById('fyop4').value;
...
function showdata(){
    ...
    if(keys!=null){
        for(i=0;i<keys.length;i++)
        {
            ...
            document.getElementsByName("gender").innerHTML=s.gender;
            ...
            // document.getElementById("board2").innerHTML=s.board2;
            ...
            // document.getElementById("board3").innerHTML=s.board3;
            ...
            // document.getElementById("board4").innerHTML=s.board4;
